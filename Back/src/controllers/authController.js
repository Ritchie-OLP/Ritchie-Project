...
const { findByEmail, save } = require('../models/userModel');
...
exports.login = async (req, res) => {
  try {
    ...
    res.json({ token, user: { id: user.id, username: user.username, email: user.email, points: user.points, creationDate: user.creation_date } });
  } catch (err) {
